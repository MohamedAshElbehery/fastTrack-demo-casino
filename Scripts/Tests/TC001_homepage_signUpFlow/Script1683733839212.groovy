...
WebUI.callTestCase(findTestCase('Modules/Home Page/signUpModule'), [
	('newEmail'): newEmail,
...
WebUI.callTestCase(findTestCase('Test Cases/Modules/Home Page/logInModule'), [('loginEmail'):newEmail], FailureHandling.STOP_ON_FAILURE)
